(function() {
    ...
    const styles = `
        <style>
            ...
            /* ═══════════════════════════════════════════
               PHONE FRAME — Full screen on mobile, mockup on desktop
               ═══════════════════════════════════════════ */
            .phone-frame {
                position: relative;
                width: 100%;
            ...
            /* ═══════════════════════════════════════════
               DYNAMIC ISLAND (desktop mockup only)
               ═══════════════════════════════════════════ */
            .phone-notch {
                position: absolute;
                top: 12px;
            ...
            /* ═══════════════════════════════════════════
               REMOTE VIDEO — FULL BLEED EDGE-TO-EDGE
               ═══════════════════════════════════════════ */
            .phone-remote-vid {
                position: absolute;
                inset: 0;
            ...
            .phone-remote-vid.speaking {
                box-shadow: inset 0 0 100px rgba(34, 197, 94, 0.12);
            }
            ...
            .phone-local-vid:active { cursor: grabbing; }
            ...
            /* ═══════════════════════════════════════════
               AUDIO MODE & CAMERA OFF — HIDE VIDEOS
               ═══════════════════════════════════════════ */
            ...
            /* Premium dark radial glow for audio-only background */
            .audio-mode .phone-frame,
            .camera-off .phone-frame {
                background: radial-gradient(ellipse at 50% 38%, #0c2d4a 0%, #080b10 65%);
            }

            /* ═══════════════════════════════════════════
               AVATAR — CENTER STAGE FOR AUDIO CALLS
               ═══════════════════════════════════════════ */
            ...
            .phone-avatar::before {
                ...
                animation: avatar-ring-pulse 2.4s cubic-bezier(0.215, 0.61, 0.355, 1) infinite;
            }
            /* Pulse Ring — Outer */
            .phone-avatar::after {
                content: '';
                ...
                animation: avatar-ring-pulse 2.4s cubic-bezier(0.215, 0.61, 0.355, 1) infinite 0.5s;
            }
            ...
            @media (max-width: 767px) {
                .phone-header { padding-top: 50px; }
            }

            /* ═══════════════════════════════════════════
               BOTTOM DOCK — FROSTED GLASS
               ═══════════════════════════════════════════ */
            .phone-controls {
                position: absolute;
                bottom: 0;
            ...
            /* ═══════════════════════════════════════════
               CIRCULAR BUTTONS — TOUCH OPTIMIZED
               ═══════════════════════════════════════════ */
            .p-btn {
                width: 58px;
                height: 58px;
            ...
            @media (max-width: 767px) {
                .p-btn.desktop-only { display: none !important; }
                .p-btn-wrap.desktop-only { display: none !important; }
            }

            /* ═══════════════════════════════════════════
               ACCEPT & REJECT — VIBRANT LARGE ACTIONS
               ═══════════════════════════════════════════ */
            .btn-accept {
                background: #22c55e;
                color: #fff;
            ...
            .btn-accept svg { width: 34px; height: 34px; }
            ...
            .btn-reject svg { width: 34px; height: 34px; }
            ...
            .p-btn-text.accept-label { color: rgba(34, 197, 94, 0.8); }
            .p-btn-text.reject-label { color: rgba(239, 68, 68, 0.7); }

            /* Hide accept label when accept btn is hidden */
            .p-btn-wrap.accept-wrap { display: none; }
            ...
            /* ═══════════════════════════════════════════
               RINGING ANIMATION — INCOMING CALL SHAKE
               ═══════════════════════════════════════════ */
    ...
    // ==========================================
    // 4. INJECT HTML UI — NATIVE PHONE LAYOUT
    // ==========================================
    const modalHtml = `
        <div id="phone-modal">
            <div class="phone-frame">

                <!-- Dynamic Island (visible on desktop mockup only) -->
                <div class="phone-notch"></div>

                <!-- Header: Username + Status + Timer -->
                ...
                <!-- Avatar for Audio-Only / Camera-Off -->
                ...
                <div class="phone-controls">
                    <div class="phone-tools">
                        <div class="p-btn-wrap">
                            ...
                            <span class="p-btn-text">Mute</span>
                        </div>
                        <div class="p-btn-wrap">
                            <button id="phone-btn-cam" class="p-btn" title="Toggle Camera">
                                <svg viewBox="0 0 24 24"><path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z"/></svg>
                            </button>
                            <span class="p-btn-text">Camera</span>
                        </div>
                        <div class="p-btn-wrap desktop-only">
                            ...
                            <span class="p-btn-text">Share</span>
                        </div>
                        <div class="p-btn-wrap desktop-only">
                            ...
                            <span class="p-btn-text">PiP</span>
                        </div>
                    </div>
                    <div class="phone-actions">
                        <div class="p-btn-wrap accept-wrap" id="accept-wrap">
                            ...
                            <span class="p-btn-text accept-label">Accept</span>
                        </div>
                        <div class="p-btn-wrap">
                            ...
                            <span class="p-btn-text reject-label">Decline</span>
                        </div>
                    </div>
                </div>
    ...
    const DOM = {
        ...
        acceptWrap: document.getElementById('accept-wrap'),
        avatarName: document.getElementById('phone-avatar-name')
    };
    ...
    function resetUI() {
        ...
        if (DOM.acceptWrap) DOM.acceptWrap.style.display = 'none';
    ...
    async function initCall(videoEnabled) {
        ...
        if (DOM.avatarName) DOM.avatarName.innerText = `@${target}`;
    ...
    window.IdlyPlugins.messageHandlers['video_offer'] = async function(data) {
        ...
        if (DOM.avatarName) DOM.avatarName.innerText = `@${data.sender}`;
        ...
        if (DOM.acceptWrap) DOM.acceptWrap.style.display = 'flex';
